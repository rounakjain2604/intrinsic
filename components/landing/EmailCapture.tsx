    ...
    return (
        <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="relative rounded-3xl overflow-hidden bg-[#2D2A26] border border-[#2D2A26] shadow-2xl">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(232,105,74,0.15),transparent_50%)] pointer-events-none" />
                ...
                <div className="relative z-10 p-10 md:p-16 grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="w-full max-w-lg lg:ml-auto">
                        <form onSubmit={handleSubmit} className="relative group/form">
                            <div aria-hidden="true" className="absolute -inset-1 bg-gradient-to-r from-[#E8694A]/30 to-[#4A7FC1]/30 rounded-2xl blur-lg opacity-0 transition duration-1000 group-hover/form:opacity-100" />
                            ...
                            <div className="relative flex flex-col sm:flex-row gap-3 bg-[#1A1816]/80 p-2 rounded-2xl border border-white/10 backdrop-blur-xl">
                                ...
                                >
                                    ...
                                    <span className={`absolute inset-0 flex items-center justify-center text-[#5B9E6F] transition-transform duration-300 ${status === 'success' ? 'translate-y-0 opacity-100' : '-translate-y-12 opacity-0'}`}>
